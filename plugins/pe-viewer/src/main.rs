...
fn print_plugin_info() {
    println!(
        r#"{{"name":"PE Viewer","version":"1.0.0","type":"viewer","description":"Displays PE (Portable Executable) binary file headers","icon":"🔧","extensions":["exe","dll","sys","ocx","scr"],"magic":"4d5a"}}"#
    );
}
