...
.PHONY: all release debug clean install-plugins install-plugins-debug setup windows help
...
# Install prerequisites for cross-compilation
setup:
	...
	@echo "Setup complete. Run 'make windows' to cross-compile."
...
help:
	...
	@echo "  setup               Install build prerequisites (cross-compile toolchain)"
